/*Создать два массива, наполнить их значениями, вывести их а также объединить их и вывести значения.
После объединения (merging) удалить пару элементов оттуда*/
#include <iostream>
